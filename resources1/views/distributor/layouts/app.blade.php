...
<body class="hold-transition sidebar-mini layout-fixed" style="font-family: IBM Plex Sans,sans-serif!important;
  ...
  <div class="wrapper">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <a href="{{ url('distributor/e-profile') }}" class="pro-li dropdown-item">
             <span><i class="far fa-user"></i></span> Profile
            </a>
            <a class="dropdown-item" href="{{ url('distributor/logout') }}" onclick="event.preventDefault();
                     document.getElementById('logout-form').submit();">
              <button class="btn btn-danger logout-button w-100"><span class="icon is-small"> <i data-feather="log-out"></i> </span>
                <form id="logout-form" action="{{ url('distributor/logout') }}" method="POST" class="d-none">
                  @csrf
                </form>
                <span>Logout</span>
              </button>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4 bg-custom-sidebar">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a href="{{ url('distributor/profile') }}" class="d-block">{{ ucwords(Auth::user()->full_name) }}</a>
          </div>
        </div>
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; 2021-{{ date('Y') }} <a href="url('distributor/money-transter')">MoneyPartner</a>.</strong>
      All rights reserved.
