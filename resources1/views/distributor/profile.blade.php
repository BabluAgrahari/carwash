        ...
        <div class="card card-success card-outline">
          <div class="card-body box-profile">
            <div class="text-center">
              <img class="profile-user-img img-fluid img-circle" id="avatar" src="{{ (!empty($user->distributor_img))?asset('attachment/').'/'.$user->distributor_img:employeeImage() }} " alt="User profile picture">
            </div>
          ...
          <div class="card-body">
            <div class="tab-content">
                ...
                <div class="active tab-pane" id="settings">
                  <form class="form-horizontal" id="upload-profile" action="{{ url('distributor/e-profile/'.$user->_id) }}" method="post" enctype="multipart/form-data">
                    {{ method_field('PUT') }}
                    @csrf
