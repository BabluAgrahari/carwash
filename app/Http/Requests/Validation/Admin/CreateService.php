...
class CreateService extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'service_tittle.required'         => 'Service Title is Required.',
            'service_tittle.string'           => 'Service Title should be string.',
            'service_tittle.max'              => 'Service Title should not be maximum 30 Character.',
